      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            I don't just build products—I create digital experiences that drive real business results.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {benefits.map((benefit, index) => (
            <Card 
              key={index}
              className="group relative p-8 bg-card/30 border-primary/20 backdrop-blur-sm hover:bg-card/50 hover:border-primary/40 transition-all duration-500 hover:scale-105"
            >
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center gap-4 px-8 py-4 rounded-full bg-gradient-primary/10 border border-primary/20 backdrop-blur-sm">
            ...
            <span className="text-muted-foreground">Join 50+ satisfied clients who've transformed their business</span>
          </div>
        </div>
      </div>
    </section>
